...
namespace XplatSolutions
{
    ...
    public class TagListView : UIView
    {
        ...
        readonly Subject<TagPressedArgs> _onLongPressSubject = new Subject<TagPressedArgs>();
        public IObservable<TagPressedArgs> OnLongPressed
        {
            get
            {
                return _onLongPressSubject;
            }
        }

        readonly Subject<IEnumerable<TagButton>> _onSelectedTagsChangedSubject = new Subject<IEnumerable<TagButton>>();
        public IObservable<IEnumerable<TagButton>> OnSelectedTagsChanged
        {
            get
            {
                return _onSelectedTagsChangedSubject;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            _onSelectedTagsChangedSubject.Dispose();
        }
    }
}